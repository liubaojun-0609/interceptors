package com.liubj.ipinterceptor.cache.impl;
 ...
 * Date: 2022/9/17
 * Time: 18:39
 * Description: Copy by https://blog.csdn.net/yu102655/article/details/112217778
 * 实际使用redis缓存的场景，一般由于redisTemplate使用不便、需要解决将java数据类型和redis六种数据结构命令的对应以及不应该直接暴露redisTemplate给service等因素考虑，
 * 需要进行进一步对redisTemplate进行封装
 */
@Getter
@AllArgsConstructor
